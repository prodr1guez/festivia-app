import 'package:festivia/pages/pointGame/point_game_controller.dart';
...
class PointGamePage extends StatefulWidget {
  const PointGamePage({Key key}) : super(key: key);

  @override
  _PointGamePageState createState() => _PointGamePageState();
}

class _PointGamePageState extends State<PointGamePage> {
  final PointGameController _controller = PointGameController();
      ...
      body: DecoratedBox(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                "A la cuenta de 3 todos señalan a...",
