...
class CongratsEventClub extends StatefulWidget {
  @override
  State<CongratsEventClub> createState() => _CongratsEventClubState();
}

class _CongratsEventClubState extends State<CongratsEventClub> {
  @override
