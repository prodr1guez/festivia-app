...
import 'register_club_controller.dart';

class RegisterClubPage extends StatefulWidget {
  @override
  _RegisterClubPageState createState() => _RegisterClubPageState();
}

class _RegisterClubPageState extends State<RegisterClubPage> {
  RegisterClubController _controller = RegisterClubController();
  String dateStart;
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: "Agregue informacion sobre el club",
          filled: true,
        ),
      ),
    );
